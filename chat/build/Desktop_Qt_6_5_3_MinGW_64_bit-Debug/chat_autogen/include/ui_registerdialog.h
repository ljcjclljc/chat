...
public:
    ...
    void setupUi(QDialog *RegisterDialog)
    {
        ...
        tip_lib = new QLabel(page_2);
        tip_lib->setObjectName("tip_lib");
        tip_lib->setLayoutDirection(Qt::LeftToRight);
        tip_lib->setAlignment(Qt::AlignCenter);

        verticalLayout_5->addWidget(tip_lib);
    ...
    void retranslateUi(QDialog *RegisterDialog)
    {
        ...
        tip_lib->setText(QCoreApplication::translate("RegisterDialog", "\346\263\250\345\206\214\346\210\220\345\212\237\357\274\2145s\345\220\216\350\277\224\345\233\236\347\231\273\351\231\206", nullptr));
